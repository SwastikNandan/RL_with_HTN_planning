...
class RobotActionsServer:
    ...
    def delete_spheres(self):
		...
		uav_loc0_x = uav_loc0[0]
		uav_loc1_x = uav_loc1[0]
		check_list = []
		#left_0, left_1 = 0, 0
		#right_0, right_1 = 0, 0
